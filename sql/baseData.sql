...
INSERT INTO PROJECT(PROJECT_NO, USER_ID, PROJECT_NAME, PROGRESS_CLASSIFICATION, PROJECT_CATEGORY, PRE_START_DATE, PRE_PERIOD, MEETING_METHOD, APPLICATION_DEADLINE, PROJECT_DETAIL, REG_DATE, PROJECT_STATUS, PROJECT_VIEW_CNT, APPLICANT_QUESTION_A) VALUES ('1', 'user01', 'testProject', '1', '1', TO_DATE('2021-01-18 16:18:04', 'YYYY-MM-DD HH24:MI:SS'), '100', '2', TO_DATE('2021-02-03 16:18:42', 'YYYY-MM-DD HH24:MI:SS'), '우리 프로젝트는 짱입니다.', TO_DATE('2021-01-15 16:19:09', 'YYYY-MM-DD HH24:MI:SS'), '1', '30', '자바 할줄 알아요?');
INSERT INTO PROJECT(PROJECT_NO, USER_ID, PROJECT_NAME, PROGRESS_CLASSIFICATION, PROJECT_CATEGORY, PRE_START_DATE, PRE_PERIOD, MEETING_METHOD, MEETING_LOCATION, APPLICATION_DEADLINE, END_DATE, PROJECT_DETAIL, REG_DATE, PROJECT_STATUS, PROJECT_VIEW_CNT, APPLICANT_QUESTION_A, APPLICANT_QUESTION_B, ENDPROJECT_CNT) VALUES ('2', 'user02', 'secondProject', '1', '2', TO_DATE('2020-12-16 16:32:03', 'YYYY-MM-DD HH24:MI:SS'), '33', '1', '서울시 강남구', TO_DATE('2021-01-05 16:32:27', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2021-01-12 16:32:39', 'YYYY-MM-DD HH24:MI:SS'), '어셈블리 같이 하실분?', TO_DATE('2020-12-09 16:32:58', 'YYYY-MM-DD HH24:MI:SS'), '3', '23', '몇살이세요', '하이요', '2');
...
ALTER TABLE POST ADD REPLY_CNT NUMERIC DEFAULT '0' NOT NULL;
